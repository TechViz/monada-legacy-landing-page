...
const HeaderLogo: HeaderLogoComponent = ({  }) => {
	...
	async function animateBuilding (building: React.RefObject<SVGGElement>) {
		const elem = building.current!;
		const { style } = elem;
		setBuildingChildrenColor(building, 'gray');
		style.transform = '';
		await sleep(1000);
		...
		<Root>
			<svg viewBox='176 79 448.5 463.9978942871094' height='463.9978942871094' width='448.5'>
				...
				<g className='building' ref={redBuildingRef}>
					<polygon className='building-body' fill='#cd004b' points='441.32 153.5 441.32 129.63 422.83 129.63 422.83 112.28 382.78 112.28 382.78 129.63 364.29 129.63 364.29 153.5 339.64 153.5 339.64 370.68 465.97 370.68 465.97 153.5 441.32 153.5'/>
				</g>
				{/* Orange building */}
				<g className='building' ref={orangeBuildingRef}>
					...
					<polygon className='building-body' fill='#f3711b' points='351.36 236.02 351.36 221.22 286.58 221.22 286.58 236.02 265.85 236.02 265.85 370.68 372.09 370.68 372.09 236.02 351.36 236.02'/>
				</g>
				{/* Yellow building */}
				<g className='building' ref={yellowBuildingRef}>
					<rect className='white-line' x='265.52' y='262.04' width='34.24' height='108.64'/>
					<rect className='building-body' fill='#fcb808' x='226.89' y='268.68' width='62.22' height='102'/>
				</g>
				{/* Blue building */}
				<g className='building' ref={blueBuildingRef}>
					...
					<polygon className='building-body' fill='#008ad1' points='529.92 370.68 436.59 370.68 436.59 177.36 529.92 231.97 529.92 370.68'/>
				</g>
				{/* Green building */}
				<g className='building' ref={greenBuildingRef}>
					<rect className='white-line' x='494.95' y='262.75' width='35.26' height='107.86'/>
					<rect className='building-body' fill='#04b34a' x='504.88' y='268.68' width='62.22' height='102'/>
				</g>
			</svg>
		</Root>
	);
